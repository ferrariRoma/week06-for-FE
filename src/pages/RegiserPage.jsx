...
const RegisterPage = () => {
  ...
  const onEmailHandler = (event) => {
    ...
    if (
      ...
      userIdRegex.test(event.currentTarget.value)
    )
      setEmailError(false);
  ...
  const onPasswordHandler = (event) => {
    ...
    if (
      !event.currentTarget.value ||
      passwordRegex.test(event.currentTarget.value)
    )
      setPasswordError(false);
    else setPasswordError(true);
    if (!confirmPassword || event.currentTarget.value === confirmPassword)
  ...
  return (
    <SignupDiv>
      ...
      >
        ...
        <br />
        <Btnset>
          <button type="submit" onClick={registAxios}>
            Join
          </button>
